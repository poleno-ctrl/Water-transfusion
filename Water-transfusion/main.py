...
class stakan(pygame.sprite.Sprite):
    def __init__(self, x , y):
        ...
        self.imaga = scale(pygame.image.load("images/feel-trans.png"), (120, 45))
        self.image = scale(pygame.image.load("images/feel-trans1.png"), (120, 45))
        self.x = x
        self.y = y
    def draw(self,screen):
        if pygame.mouse.get_pos()[0] in range(15, 65) and pygame.mouse.get_pos()[1] in range(85, 135):
            screen.blit(scale(pygame.image.load("images/restart_grey.png"), (50, 50)),(15, 70))
        else:
            screen.blit(scale(pygame.image.load("images/restart.png"), (50, 50)),(15, 70))
    def work1(self,size1,size2,size3, size4,mousex,mousey,tap,need):
        ...
        screen.blit(scale(pygame.image.load("images/stakan.png"), (self.x, self.y)), (space, 390-self.y))
        ...
        if pouring_1 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)), (space+stakan1.x//2- 35, 507))
        else:
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)), (space+stakan1.x//2-52, 507))
        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)), (space+stakan1.x//2-44, 448))
        ...
        if have1 == need:
            if action<= min_motions:
                ...
                file = open('levels/'+chosen+'.txt', 'w', encoding = 'utf-8')
                file.write('\n'.join(tasks_texts))
                file.close()
    ...
    def work2(self,size1,size2,size3, size4,mousex,mousey,tap,need):
        ...
        screen.blit(scale(pygame.image.load("images/stakan.png"), (self.x, self.y)), (space*2+stakan1.x, 390-self.y))
        ...
        if pouring_2 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)), (space*2+stakan1.x+stakan2.x//2-35, 507))
        else:
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)), (space*2+stakan1.x+stakan2.x//2-52, 507))
        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)), (space*2+stakan1.x+stakan2.x//2-44, 448))
    ...
    def work3(self,size1,size2,size3, size4,mousex,mousey,tap,need):
        ...
        screen.blit(scale(pygame.image.load("images/stakan.png"), (self.x, self.y)), (space*3+stakan1.x+stakan2.x, 390-self.y))
        ...
        if pouring_3 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)), (space*3+stakan1.x+stakan2.x+stakan3.x//2-35, 507))
        else:
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)), (space*3+stakan1.x+stakan2.x+stakan3.x//2-52, 507))
        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)), (space*3+stakan1.x+stakan2.x+stakan3.x//2-44, 448))
    ...
    def work4(self,size1,size2,size3, size4,mousex,mousey,tap,need):
        ...
        screen.blit(scale(pygame.image.load("images/stakan.png"), (self.x, self.y)), (space*4+stakan1.x+stakan2.x+stakan3.x, 390-self.y))
        ...
        if pouring_4 or chosen == 'ограниченный долив':
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ВЫЛИТЬ', 1, (1, 1, 1)), (space*4+stakan1.x+stakan2.x+stakan3.x+stakan4.x//2-35, 507))
        else:
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ЗАПОЛНИТЬ', 1, (1, 1, 1)), (space*4+stakan1.x+stakan2.x+stakan3.x+stakan4.x//2-52, 507))
        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 25).render('ПЕРЕЛИТЬ', 1, (1, 1, 1)), (space*4+stakan1.x+stakan2.x+stakan3.x+stakan4.x//2-44, 448))
...
pygame.init()
pygame.mixer.init()
sound = pygame.mixer.Sound('sounds/zvuk-knopki-myshi.wav')
sound1 = pygame.mixer.Sound('sounds/zvuk-chay-letsya-v-kruzhku.wav')
sound2 = pygame.mixer.Sound('sounds/den-pobedy-z_uk-1.wav')
screen = pygame.display.set_mode((750, 550))
pygame.display.set_caption("СТАКАНЧИКИ")
fon = scale(pygame.image.load("images/fon.jpg"), (750, 550))
pygame.font.init()
...
while True:
    ...
    if task:
        ...
        text7 = pygame.font.Font('fonts/8320.ttf', 35).render('ОТМЕРЬТЕ '+ need + str(ending), 1, (1, 1, 1))
        screen.blit(text7, (100, 10))
        action = int(action)
        need = int(need)
        if pygame.mouse.get_pos()[0] in range(15, 65) and pygame.mouse.get_pos()[1] in range(10, 70):
            screen.blit(scale(pygame.image.load("images/22_grey.png"), (50, 50)), (15, 10))
        else:
            screen.blit(scale(pygame.image.load("images/22.png"), (50, 50)), (15, 10))
        ...
        switch = False
        screen.blit(pygame.font.Font('fonts/19363.ttf', 120).render('YOU WIN!', 1, (1,1,1)), (60, 30))
        ...
        if pygame.mouse.get_pos()[0] in range(340, 410) and pygame.mouse.get_pos()[1] in range(470, 540):
            screen.blit(scale(pygame.image.load("images/restart_grey.png"), (70, 70)),(340, 470))
            ...
            screen.blit(scale(pygame.image.load("images/restart.png"), (70, 70)),(340, 470))
        if pygame.mouse.get_pos()[0] in range(15, 65) and pygame.mouse.get_pos()[1] in range(10, 70):
            screen.blit(scale(pygame.image.load("images/22_grey.png"), (50, 50)), (15, 10))
        else:
            screen.blit(scale(pygame.image.load("images/22.png"), (50, 50)), (15, 10))
        ...
        switch = False
        name = pygame.font.Font('fonts/19369.ttf', 100).render('TRANSFUSIONS', False, (1,1,1))
        ...
        if pygame.mouse.get_pos()[0] in range(114, 325) and pygame.mouse.get_pos()[1] in range(275, 414):
            screen.blit(scale(pygame.image.load("images/кнопка_grey.png"), (211, 139)), (114, 275))
        else:
            screen.blit(scale(pygame.image.load("images/кнопка.png"), (211, 139)), (114, 275))
        if pygame.mouse.get_pos()[0] in range(428, 639) and pygame.mouse.get_pos()[1] in range(275, 414):
            screen.blit(scale(pygame.image.load("images/кнопка_grey.png"), (211, 139)), (428, 275))
        else:
            screen.blit(scale(pygame.image.load("images/кнопка.png"), (211, 139)), (428, 275))
        ...
        switch = False
        file = open('levels/'+chosen+'.txt', 'r', encoding = 'utf-8')
        ...
        if tasks_texts!='':
                ...
                if page*6+i<=tasks_amount:
                    if i == 1:
                        if pygame.mouse.get_pos()[0] in range(100, 336) and pygame.mouse.get_pos()[1] in range(125, 210):
                            screen.blit(scale(pygame.image.load("images/level_grey.png"), (236, 85)), (100, 125))
                        else:
                            screen.blit(scale(pygame.image.load("images/level.png"), (236, 85)), (100, 125))
                        screen.blit(pygame.font.SysFont('Comic Sans MS', 22).render('ЗАДАЧА '+str(page*6+i), 1, (1,1,1)), (105, 130))
                        result_i = page*6+i
                        if tasks_texts[result_i-1][-1]=='0':
                            screen.blit(scale(pygame.image.load("images/squre.png"), (35, 35)), (280, 150))
                        else:
                            screen.blit(scale(pygame.image.load("images/squre_tick.png"), (41, 35)), (280, 150))
                        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 20).render('ВАШ РЕЗУЛЬТАТ: '+tasks_texts[page*6+i-1].split()[-2], 1, (1,1,1)), (105, 180))
                    elif i ==2:
                        if pygame.mouse.get_pos()[0] in range(100, 336) and pygame.mouse.get_pos()[1] in range(260, 345):
                            screen.blit(scale(pygame.image.load("images/level_grey.png"), (236, 85)), (100, 260))
                        else:
                            screen.blit(scale(pygame.image.load("images/level.png"), (236, 85)), (100, 260))
                        screen.blit(pygame.font.SysFont('Comic Sans MS', 22).render('ЗАДАЧА '+str(page*6+i), 1, (1,1,1)), (105, 265))
                        result_i = page*6+i
                        if tasks_texts[result_i-1][-1]=='0':
                            screen.blit(scale(pygame.image.load("images/squre.png"), (35, 35)), (280, 285))
                        else:
                            screen.blit(scale(pygame.image.load("images/squre_tick.png"), (41, 35)), (280, 285))
                        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 20).render('ВАШ РЕЗУЛЬТАТ: '+tasks_texts[page*6+i-1].split()[-2], 1, (1,1,1)), (105, 315))
                    elif i ==3:
                        if pygame.mouse.get_pos()[0] in range(100, 336) and pygame.mouse.get_pos()[1] in range(395, 480):
                            screen.blit(scale(pygame.image.load("images/level_grey.png"), (236, 85)), (100, 395))
                        else:
                            screen.blit(scale(pygame.image.load("images/level.png"), (236, 85)), (100, 395))
                        screen.blit(pygame.font.SysFont('Comic Sans MS', 22).render('ЗАДАЧА '+str(page*6+i), 1, (1,1,1)), (105, 400))
                        result_i = page*6+i
                        if tasks_texts[result_i-1][-1]=='0':
                            screen.blit(scale(pygame.image.load("images/squre.png"), (35, 35)), (280, 420))
                        else:
                            screen.blit(scale(pygame.image.load("images/squre_tick.png"), (41, 35)), (280, 420))
                        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 20).render('ВАШ РЕЗУЛЬТАТ: '+tasks_texts[page*6+i-1].split()[-2], 1, (1,1,1)), (105, 450))
                    elif i ==4:
                        if pygame.mouse.get_pos()[0] in range(414, 650) and pygame.mouse.get_pos()[1] in range(125, 210):
                            screen.blit(scale(pygame.image.load("images/level_grey.png"), (236, 85)), (414, 125))
                        else:
                            screen.blit(scale(pygame.image.load("images/level.png"), (236, 85)), (414, 125))
                        screen.blit(pygame.font.SysFont('Comic Sans MS', 22).render('ЗАДАЧА '+str(page*6+i), 1, (1,1,1)), (419, 130))
                        result_i = page*6+i
                        if tasks_texts[result_i-1][-1]=='0':
                            screen.blit(scale(pygame.image.load("images/squre.png"), (35, 35)), (594, 150))
                        else:
                            screen.blit(scale(pygame.image.load("images/squre_tick.png"), (41, 35)), (594, 150))
                        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 20).render('ВАШ РЕЗУЛЬТАТ: '+tasks_texts[page*6+i-1].split()[-2], 1, (1,1,1)), (419, 180))
                    elif i == 5:
                        if pygame.mouse.get_pos()[0] in range(414, 650) and pygame.mouse.get_pos()[1] in range(260, 345):
                            screen.blit(scale(pygame.image.load("images/level_grey.png"), (236, 85)), (414, 260))
                        else:
                            screen.blit(scale(pygame.image.load("images/level.png"), (236, 85)), (414, 260))
                        screen.blit(pygame.font.SysFont('Comic Sans MS', 22).render('ЗАДАЧА '+str(page*6+i), 1, (1,1,1)), (419, 265))
                        result_i = page*6+i
                        if tasks_texts[result_i-1][-1]=='0':
                            screen.blit(scale(pygame.image.load("images/squre.png"), (35, 35)), (594, 285))
                        else:
                            screen.blit(scale(pygame.image.load("images/squre_tick.png"), (41, 35)), (594, 285))
                        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 20).render('ВАШ РЕЗУЛЬТАТ: '+tasks_texts[page*6+i-1].split()[-2], 1, (1,1,1)), (419, 315))
                    else:
                        if pygame.mouse.get_pos()[0] in range(414, 650) and pygame.mouse.get_pos()[1] in range(395, 480):
                            screen.blit(scale(pygame.image.load("images/level_grey.png"), (236, 85)), (414, 395))
                        else:
                            screen.blit(scale(pygame.image.load("images/level.png"), (236, 85)), (414, 395))
                        screen.blit(pygame.font.SysFont('Comic Sans MS', 22).render('ЗАДАЧА '+str(page*6+i), 1, (1,1,1)), (419, 400))
                        result_i = page*6+i
                        if tasks_texts[result_i-1][-1]=='0':
                            screen.blit(scale(pygame.image.load("images/squre.png"), (35, 35)), (594, 420))
                        else:
                            screen.blit(scale(pygame.image.load("images/squre_tick.png"), (41, 35)), (594, 420))
                        screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 20).render('ВАШ РЕЗУЛЬТАТ: '+tasks_texts[page*6+i-1].split()[-2], 1, (1,1,1)), (419, 450))
            if pygame.mouse.get_pos()[0] in range(310, 360) and pygame.mouse.get_pos()[1] in range(490, 540):
                screen.blit(scale(pygame.image.load("images/arrow_left_grey.png"), (50, 50)), (310, 490))
            else:
                screen.blit(scale(pygame.image.load("images/arrow_left.png"), (50, 50)), (310, 490))
            if pygame.mouse.get_pos()[0] in range(390, 440) and pygame.mouse.get_pos()[1] in range(490, 540):
                screen.blit(scale(pygame.image.load("images/arrow_right_grey.png"), (50, 50)), (390, 490))
            else:
                screen.blit(scale(pygame.image.load("images/arrow_right.png"), (50, 50)), (390, 490))
            if e.type == pygame.MOUSEBUTTONDOWN and e.button == 1:
            ...
            screen.blit(pygame.font.SysFont('fonts/Nunito-ExtraLight.ttf', 30).render('ЗАДАЧИ ЭТОГО ТИПА ЕЩЁ НЕ ДОБАВЛЕНЫ', 1, (1,1,1)), (145, 295))
        screen.blit(pygame.font.Font('fonts/8320.ttf', 35).render('ВЫБЕРИТЕ ЗАДАЧУ, КОТОРУЮ', 1, (1,1,1)), (100, 10))
        screen.blit(pygame.font.Font('fonts/8320.ttf', 35).render('БУДЕТЕ РЕШАТЬ', 1, (1,1,1)), (200, 55))
